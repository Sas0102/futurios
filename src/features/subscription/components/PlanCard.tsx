...
export default function PlanCard({
  ...
  const features = [
    ...
    {
      label: "Calls / Month",
      value: plan.limits.max_calls_per_month ?? "Unlimited",
    },
  ...
  return (
    ...
    >
      ...
      <h2 className="text-3xl font-bold text-white">{plan.display_name}</h2>

      <p className="mt-2 text-base text-gray-400 capitalize">
        {plan.name} plan
      </p>

      <p className="mt-5 text-lg font-semibold text-orange-500">
